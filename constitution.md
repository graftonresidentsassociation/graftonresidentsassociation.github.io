...
1. The name of the group shall be: Grafton Residents Association.
	...
	(Christchurch Street and Burleigh Place, Cambridge).
...
2. The aims of the Association shall be to:
	...
	b) To seek improvement of the social existence, environmental and
	personal health, and the general well-being of members, specifically 
...
3. The Short-Term Aims of the Association shall be:
	...
	a) Working with Cambridge City Council and any other organisation 
	necessary to enforce upon building contractors the terms agreed in the planning 
	...
	members' inalienable right to the quiet enjoyment of their homes since 
	work commenced.

	c) The association shall seek to have the weekly fire alarm tests preferably 
	eliminated or reduced in length and moved to a time when the fewest residents 
	are expected to be aggravated by this event.
...
5. Management
	...
	If there is a tied vote, then the Chairperson shall the casting vote. 
	...
	i) The Committee shall undertake to keep members properly informed 
...
9. Finance:
	...
	and may open a bank account in its name as necessary.
